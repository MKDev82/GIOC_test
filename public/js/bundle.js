    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status = 'success') location.assign('/'); // location.reload();
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"signupNewUser.js":[function(require,module,exports) {
"use strict";
...
var signupNewUser = /*#__PURE__*/function () {
  ...
  return function signupNewUser(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var _signupNewUser = require("./signupNewUser");
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _signupNewUser.signupNewUser)(name, email, password, passwordConfirm);
  });
}
